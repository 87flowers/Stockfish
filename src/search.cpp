...
void Search::Worker::iterative_deepening() {
    ...
    for (int i = 0; i < LOW_PLY_HISTORY_SIZE - 2; i++)
    {
        lowPlyHistory[i] = lowPlyHistory[i + 2];
    }
    lowPlyHistory[LOW_PLY_HISTORY_SIZE - 2].fill(89);
    lowPlyHistory[LOW_PLY_HISTORY_SIZE - 1].fill(89);
